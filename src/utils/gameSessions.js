export const GAME_SESSION_KEYS={'card-bluff':'card_bluff_session','shadow-detective':'shadow_detective_session','nightfall-village':'nightfall_village_session','puzzle-tower':'puzzle_tower_session'};
